// Live capture: what the practice session measures while the TA speaks. The
// review pipeline works from `WordTiming[]` (see review.ts); these types feed
// the live meters and the deterministic speaking score (speakingScore.ts).
// See docs/design.md and docs/rubric.md.

/** A silence gap in the session audio. */
...
export interface DeliveryMetrics {
  ...
  /** True when word timestamps were synthesized (Scribe's timestamped commit
